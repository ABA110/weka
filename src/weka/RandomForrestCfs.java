...
public class RandomForrestCfs {
    ...
    public static void main(String args[]) throws Exception {
       ...
       // for(int numberoftrees = 100;numberoftrees <= 400 ;numberoftrees=+100 ){
        ...
        RandomForrestCfs RFGSW = new RandomForrestCfs();
        ...
        RFGSW.classifyme(60, 3);
        RFGSW.classifyme(60, 5);
        RFGSW.classifyme(60, 7);
        RFGSW.classifyme(100, 3);
        RFGSW.classifyme(100, 5);
        RFGSW.classifyme(100, 7);
        RFGSW.classifyme(200, 5);
        RFGSW.classifyme(200, 7);
        RFGSW.classifyme(300, 7);
        RFGSW.classifyme(400, 7);
        
        
    }
        
        public void classifyme(int numberoftrees, int numberOfFeatures ) throws Exception   {
